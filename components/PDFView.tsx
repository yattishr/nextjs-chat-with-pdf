...
// chat-with-pdf-f75c7
// gsutil cors set cors.json gs://chat-with-pdf-f75c7.appspot.com

// run >>> // gsutil cors set cors.json gs://chat-with-pdf-f75c7.appspot.com
...
function PDFView({ url }: { url: string }) {
  ...
  console.log(`Logging URL: ${url} from PDFView component...`);
